...
const Attendance = () => {
  ...
  const fetchLoginHistory = useCallback(async () => {
    try {
      ...
      // Define calculateTotalBreakTime inside this callback to prevent unnecessary re-renders
      ...
      // Define calculateTotalWorkingTime inside this callback to prevent unnecessary re-renders
...
const fetchShiftDetails = useCallback(async () => {
  ...
  // Calculate total break time in milliseconds
    ...
    //     console.log('Error logging action:', error.response?.data || error.message);
    //   }
    // };
    ...
    if (loginOut !== 'Sign In') {
      console.log('Cannot take a break unless signed in');
    ...
    try {
      ...
      console.log('Error logging break action:', error.response?.data || error.message);
    }
  };
  ...
  useEffect(() => {
    ...
    fetchLoginHistory(); // This will not trigger unnecessary rerenders now
    fetchShiftDetails(); // This will not trigger unnecessary rerenders now
  
    return () => clearInterval(intervalId);
  }, [userName, fetchLoginHistory, fetchShiftDetails]); // Use the memoized functions here
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div>
          <Link href={'/pages/LeaveApplyPage'} className='text-white px-4 py-2 rounded-lg bg-black'>Leave Apply</Link>
